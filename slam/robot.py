...
class Robot:
    def __init__(self, wheels_width_ccw, wheels_width_cw, wheels_scale, camera_matrix, camera_dist):
        # State is a vector of [x,y,theta]'
        self.state = np.zeros((3,1))
        
        # Wheel parameters
        self.wheels_width_ccw = wheels_width_ccw  # The distance between the left and right wheels
        self.wheels_width_cw = wheels_width_cw
    ...
    def convert_wheel_speeds(self, left_speed, right_speed):
        ...
        if left_speed > right_speed:
            angular_velocity = (right_speed_m - left_speed_m) / self.wheels_width_cw
        else:
            angular_velocity = (right_speed_m - left_speed_m) / self.wheels_width_ccw
    ...
    def covariance_drive(self, drive_meas):
        ...
        Jac1 = np.array([[self.wheels_scale/2, self.wheels_scale/2],
                [-self.wheels_scale/self.wheels_width_ccw, self.wheels_scale/self.wheels_width_ccw]])
